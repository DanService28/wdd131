...
const temples = [
    ...
    {
        templeName: "San Juan Puero Rico",
        location: "Caribbean, Puerto Rico",
        dedicated: "2023, January, 15",
        area: 6988,
        imageUrl:
        "https://churchofjesuschristtemples.org/assets/img/temples/san-juan-puerto-rico-temple/san-juan-puerto-rico-temple-45092.jpg"
    }
  ];

createTempleCard(temples)

const homeButtom = document.querySelector("#home")
...
smallTemples.addEventListener( "click", () => {
    createTempleCard(temples.filter(temple => temple.area < 9000))
})
